...
/*!
 ...
 @remarks 资源管理
 */
- (void)subscribeStreams:(NSArray<RCRTCInputStream *> *)subStreams
             tinyStreams:(NSArray<RCRTCInputStream *> *)subTinyStreams
      unsubscribeStreams:(NSArray<RCRTCInputStream *> *)unsubStreams
              completion:(RCRTCOperationCallback)completion;
...
- (void)requestJoinOtherRoom:(NSString *)inviteeRoomId
                  ...
                  completion:(RCRTCOperationCallback)completion DEPRECATED_MSG_ATTRIBUTE("use requestRoomPK:forKey:userId:autoMix:extra:completion: API instead");
...
/*!
 ...
 @remarks 资源管理
 */
- (void)requestRoomPK:(NSString *)inviteeRoomId
               userId:(NSString *)inviteeUserId
              autoMix:(BOOL)autoMix
                extra:(NSString *)extra
           completion:(RCRTCOperationCallback)completion;
...
- (void)cancelRequestJoinOtherRoom:(NSString *)inviteeRoomId
                            userId:(NSString *)inviteeUserId
                             extra:(NSString *)extra
                        completion:(RCRTCOperationCallback)completion DEPRECATED_MSG_ATTRIBUTE("use cancelRequestJoinPK:userId:extra:completion: API instead");
...
/*!
 ...
 @remarks 资源管理
 */
- (void)cancelRequestJoinPK:(NSString *)inviteeRoomId
                     userId:(NSString *)inviteeUserId
                      extra:(NSString *)extra
                 completion:(RCRTCOperationCallback)completion;
...
- (void)responseJoinOtherRoom:(NSString *)inviterRoomId
                      ...
                      autoMix:(BOOL)autoMix
                        extra:(NSString *)extra
                   completion:(RCRTCOperationCallback)completion DEPRECATED_MSG_ATTRIBUTE("use responseRoomPK:userId:agree:autoMix:extra:completion: API instead");
...
/*!
 ...
 @remarks 资源管理
 */
- (void)responseRoomPK:(NSString *)inviterRoomId
                userId:(NSString *)inviterUserId
                 agree:(BOOL)agree
               autoMix:(BOOL)autoMix
                 extra:(NSString *)extra
...
/*!
 ...
 @remarks 资源管理
 */
- (void)quitRoomPK:(NSString *)roomId
        completion:(RCRTCOperationCallback)completion;
...
/*!
 ...
 Added from 5.1.9
 */
- (void)switchToAudienceOnSucceed:(void (^)(void))onSucceed
                         onFailed:(void (^)(RCRTCCode code))onFailed
                         onKicked:(void (^)(void))onKicked;
...
- (void)switchToBroadcaster:(NSArray<RCRTCOutputStream *> *)publishStreams
                  onSucceed:(void (^)(RCRTCLiveInfo *liveInfo))onSucceed
                   onFailed:(void (^)(RCRTCCode code))onFailed
                   onKicked:(void (^)(void))onKicked;

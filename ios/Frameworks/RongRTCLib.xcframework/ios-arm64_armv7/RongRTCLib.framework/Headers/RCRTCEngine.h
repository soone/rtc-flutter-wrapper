...
- (void)leaveOtherRoom:(nonnull NSString *)roomId
        notifyFinished:(BOOL)isNotify
            completion:(nonnull RCRTCOperationCallback)completion DEPRECATED_MSG_ATTRIBUTE("use leaveOtherRoom:completion: API instead");
...
/*!
 ...
 @remarks 房间管理
 */
- (void)queryRTCRoomJoinedInfo:(void(^)(BOOL isSuccess,
                                        RCRTCCode code,
                                        NSArray <RCRTCJoinedRoomInfo *> *infoArray))completion;
...
/*!
 ...
 @remarks RCRTCEngine：统计接口
 */
@property (nonatomic, weak) id<RCRTCProbeTestDelegate> probeTestDelegate;
 ...
 */
- (void)startRTCProbeTest:(RCRTCOperationCallback)callback;
...
/*!
 ...
 @remarks RCRTCEngine：探测接口
 */
- (void)stopRTCProbeTest:(RCRTCOperationCallback)callback;
